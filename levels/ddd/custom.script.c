...
const LevelScript local_objects_ddd_1_[] = {
    ...
    OBJECT_WITH_ACTS(MODEL_YOSHI_EGG,4583,97,-904,0,0,0,0x0, bhvCustomSMSRSmallBee,59),
    ...
    OBJECT_WITH_ACTS(MODEL_YOSHI_EGG,-2992,-174,-3625,0,0,0,0x0, bhvCustomSMSRSmallBee,63),
    ...
    OBJECT_WITH_ACTS(MODEL_YOSHI_EGG,6057,1345,-4737,0,0,0,0x0, bhvCustomSMSRSmallBee,63),
