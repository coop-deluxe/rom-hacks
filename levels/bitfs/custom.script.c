...
const LevelScript local_objects_bitfs_1_[] = {
    ...
    OBJECT_WITH_ACTS(MODEL_TTM_BLUE_SMILEY,259,1237,-2528,0,0,0,0x0, bhvCustomSMSRYoshiCoin,31),
    OBJECT_WITH_ACTS(MODEL_TTM_BLUE_SMILEY,3860,23,-3357,0,0,0,0x0, bhvCustomSMSRYoshiCoin,31),
    OBJECT_WITH_ACTS(MODEL_TTM_BLUE_SMILEY,-1746,1001,-3642,0,0,0,0x0, bhvCustomSMSRYoshiCoin,31),
    OBJECT_WITH_ACTS(0,-4151,831,4235,90,0,0,0x110000, bhvCoinFormation,31),
    OBJECT_WITH_ACTS(MODEL_TTM_BLUE_SMILEY,3347,1321,4089,0,0,0,0x0, bhvCustomSMSRYoshiCoin,31),
    ...
    OBJECT_WITH_ACTS(MODEL_TTM_BLUE_SMILEY,-6148,121,866,0,0,0,0x0, bhvCustomSMSRYoshiCoin,31),
