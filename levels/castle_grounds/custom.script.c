...
const LevelScript level_castle_grounds_entry[] = {
    ...
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR_0_STARS, custom_castle_door_0_star_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR_1_STAR, custom_castle_door_1_star_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_DOOR_3_STARS, custom_castle_door_3_star_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_KEY_DOOR, custom_key_door_geo),
    LOAD_MODEL_FROM_GEO(MODEL_CASTLE_CASTLE_DOOR, custom_castle_door_geo),
