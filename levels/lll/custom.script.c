...
const LevelScript local_objects_lll_1_[] = {
    ...
    OBJECT_WITH_ACTS(MODEL_TTM_BLUE_SMILEY,3570,3693,3889,0,90,0,0xb0000, bhvCustomSMSRAngrySun,1),
    OBJECT_WITH_ACTS(MODEL_TTM_BLUE_SMILEY,-115,1710,-931,0,0,0,0xc0000, bhvCustomSMSRAngrySun,62),
    ...
    OBJECT_WITH_ACTS(MODEL_TTM_YELLOW_SMILEY,5980,3255,-7884,0,0,0,0x0, bhvCustomSMSRYoshiCoin,63),
    OBJECT_WITH_ACTS(MODEL_TTM_YELLOW_SMILEY,3397,3141,-1280,0,0,0,0x0, bhvCustomSMSRYoshiCoin,63),
    OBJECT_WITH_ACTS(MODEL_TTM_YELLOW_SMILEY,5067,4007,3942,0,0,0,0x0, bhvCustomSMSRYoshiCoin,63),
    OBJECT_WITH_ACTS(MODEL_TTM_YELLOW_SMILEY,-4548,-2395,37,0,0,0,0x0, bhvCustomSMSRYoshiCoin,63),
    OBJECT_WITH_ACTS(MODEL_TTM_YELLOW_SMILEY,-5209,2826,5082,0,0,0,0x0, bhvCustomSMSRYoshiCoin,63),
